...
const useStyles = createThemedStyles((colors, theme) => ({section:{gap:12,borderTopWidth:1,borderColor:colors.line,paddingTop:16},row:{flexDirection:"row",justifyContent:"space-between",alignItems:"center",gap:10,flexWrap:"wrap"},heading:{flex:1,gap:5},title:{fontSize:16,fontWeight: "600",color:colors.text},muted:{fontSize:12,color:colors.textMuted,lineHeight:20},action:{fontSize:12,color:colors.mint,paddingVertical:6},remove:{fontSize:12,color: theme.danger,lineHeight:20},list:{gap:12},card:{backgroundColor:colors.surface,borderRadius:radii.md,padding:12,gap:6},object:{color:colors.text,fontSize:16,fontWeight:"700",flexShrink:1},status:{color:colors.mint,fontSize:11},quote:{color:colors.text,lineHeight:22},actions:{flexDirection:"row",flexWrap:"wrap",gap:16},overlay:{flex:1,backgroundColor: theme.overlay,justifyContent:"center",alignItems:"center",padding:spacing.md},modal:{width:"100%",maxWidth:520,maxHeight:"90%",gap:12},history:{maxHeight:430}}));
