...
const useStyles = createThemedStyles((colors, theme) => ({ page: { flex: 1, backgroundColor: colors.canvas, alignItems: "center", justifyContent: "center", padding: spacing.lg }, card: { width: "100%", maxWidth: 460, alignItems: "center", gap: spacing.md }, icon: { color: colors.mint, fontSize: 38 }, title: { color: colors.text, fontSize: 23, fontWeight: "700", textAlign: "center" }, copy: { color: colors.textMuted, lineHeight: 22, textAlign: "center" }, error: { color: theme.danger, textAlign: "center" } }));
