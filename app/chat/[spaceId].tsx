...
import type { AgentFeedbackRating, AgentJob, AgentProposal, AgentRequest, ChatMessage, PetCornerStory, PetObservationStatus, QueuedMessage } from "../../src/data/types";
...
export default function ChatScreen() {
  ...
  const markLatestRead = useCallback(() => {
    ...
    void repository.markRead(spaceId).catch(() => { lastMarkedReadKeyRef.current = null; });
  }, [repository, spaceId]);
  ...
  }, [connected, outbox, profile, publishMessages, repository, spaceId]);
