...
const useStyles = createThemedStyles((colors, theme) => ({ page: { flex: 1, backgroundColor: colors.canvas }, loading: { flex: 1, backgroundColor: colors.canvas, alignItems: "center", justifyContent: "center" }, content: { width: "100%", maxWidth: 560, alignSelf: "center", padding: spacing.lg, gap: spacing.md }, back: { color: colors.mint, fontWeight: "600" }, title: { color: colors.text, fontSize: 30, fontWeight: "700" }, copy: { color: colors.textMuted, lineHeight: 22 }, codeCard: { gap: spacing.md }, codeLabel: { color: colors.textMuted, fontSize: 12 }, code: { color: theme.danger, fontSize: 24, fontWeight: "700", letterSpacing: 2, textAlign: "center", paddingVertical: spacing.lg }, placeholder: { padding: spacing.xl }, placeholderText: { color: colors.textMuted, textAlign: "center" }, error: { color: theme.danger } }));
